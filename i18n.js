...
window.SADAQAH_I18N = {
  en: {
    ...
    "mod.help": "Helping Hands",
    "mod.help.desc": "Imagine a place where every kind thing you do is a special gift!",
    "mod.lexic": "Lexicon",
    "mod.lexic.desc": "Glossary of key charity terms.",
    "mod.wall": "Community Wall",
    "mod.wall.desc": "Read stories and share your own.",
    "mod.enter": "Enter",

    "project.title": "The AI Sadaqah Journey: Explore, Give, Inspire",
    "home.funding": "Led by <em>Northwestern University in Qatar</em> and funded by the <em>Qatar Research, Development and Innovation (QRDI) Council</em> and the <em>Regulatory Authority for Charitable Activities (RACA)</em> under Grant No. <em>MCSC02-0217-250013</em>.",
    "about.title": "About",
    "about.funding": "Funding and Institutional Support",
    "about.fundingBody": "<em>The AI Sadaqah Journey: Explore, Give, Inspire</em> is led by <em>Northwestern University in Qatar</em> and funded by the <em>Qatar Research, Development and Innovation (QRDI) Council</em> and the <em>Regulatory Authority for Charitable Activities (RACA)</em> under Grant No. <em>MCSC02-0217-250013</em>.",
    "footer": "The AI Sadaqah Journey | Led by Northwestern University in Qatar | Funded by QRDI Council and RACA | Grant No. MCSC02-0217-250013",

    "search.stories": "Search stories…",
    "search.lex": "Search terms…",
  ...
  ar: {
    ...
    "mod.help": "الأيدي المساعدة",
    "mod.help.desc": "تخيل مكاناً يكون فيه كل عمل طيب تقوم به بمثابة هدية خاصة!",
    "mod.lexic": "معجم المصطلحات",
    "mod.lexic.desc": "مسرد لأهم مصطلحات الصدقة.",
    "mod.wall": "جدار المجتمع",
    "mod.wall.desc": "اقرأ الحكايات وشارك قصتك.",
    "mod.enter": "ادخل",

    "project.title": "رحلة الصدقة بالذكاء الاصطناعي: استكشف، أعطِ، ألهم",
    "home.funding": "بقيادة <em>جامعة نورث وسترن في قطر</em> وبدعم من <em>مجلس قطر للبحث والتطوير والابتكار (QRDI)</em> و<em>هيئة تنظيم الأعمال الخيرية (RACA)</em> بموجب المنحة رقم <em>MCSC02-0217-250013</em>.",
    "about.title": "حول المشروع",
    "about.funding": "التمويل والدعم المؤسسي",
    "about.fundingBody": "<em>رحلة الصدقة بالذكاء الاصطناعي: استكشف، أعطِ، ألهم</em> بقيادة <em>جامعة نورث وسترن في قطر</em> وبدعم من <em>مجلس قطر للبحث والتطوير والابتكار (QRDI)</em> و<em>هيئة تنظيم الأعمال الخيرية (RACA)</em> بموجب المنحة رقم <em>MCSC02-0217-250013</em>.",
    "footer": "رحلة الصدقة بالذكاء الاصطناعي | بقيادة جامعة نورث وسترن في قطر | بدعم من مجلس QRDI و RACA | المنحة رقم MCSC02-0217-250013",

    "search.stories": "ابحث في الحكايات…",
    "search.lex": "ابحث في المصطلحات…",
